...
document.querySelector('#search-btn').onclick = () =>{
    searchForm.classList.toggle('searchactive');
    shoppingCart.classList.remove('cartactive');
...
document.querySelector('#cart-btn').onclick = () =>{
    shoppingCart.classList.toggle('cartactive');
    loginform.classList.remove('loginactive');
    menuItems.classList.remove('menuactive');
...
document.querySelector('#login-btn').onclick = () =>{
    loginform.classList.toggle('loginactive');
    menuItems.classList.remove('menuactive');
    searchForm.classList.remove('searchactive');
    shoppingCart.classList.remove('cartactive');
}
